...
public class FlutterBluePlugin implements FlutterPlugin, ActivityAware, MethodCallHandler, RequestPermissionsResultListener {
    ...
    private void invokeMethodUIThread(final String name, final byte[] byteArray) {
        ...
        Boolean isActivityNull = (activity == null);
        Log.d("KEEHOO_DEBUG", "Activity null " + isActivityNull.toString());

        Boolean isChannelNull = (channel == null);
        Log.d("KEEHOO_DEBUG", "Channel null " + isChannelNull.toString());

        Log.d("KEEHOO_DEBUG", "Name = " + name);
//        Log.d("KEEHOO_DEBUG", "Name null " + name + " " + (Boolean) (name == null).toString());
//        Log.d("KEEHOO_DEBUG", "byte array null " + byteArray.toString() + " " + (Boolean)(byteArray == null).toString());
